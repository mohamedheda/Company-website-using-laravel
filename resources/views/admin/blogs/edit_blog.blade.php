            ...
            <div class="card-body">
                ...
                <form action="{{route('update.blog')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="{{$blog->blog_title}}" name="blog_title" id="name">
                            @error('blog_title')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="{{$blog->blog_tags}}" name="blog_tags" data-role="tagsinput" value="laravel,php">
                            @error('blog_tags')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                ...
                <div class="row mb-3">
                    <label for="" class="col-sm-2 col-form-label"></label>
                    <div class="col-sm-10">
                    <img class="rounded avatar-lg " src="{{asset($blog->blog_image)}}" id="showImage" alt=" image">
                    </div>
                </div>
                <!-- end row -->
