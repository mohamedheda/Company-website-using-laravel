@php 
$images=App\Models\MultiImage::take(6)->get();
@endphp
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="standard__blog__post">
                                ...
                                <div class="standard__blog__content">
                                    ...
                                    <p>{!! Str::limit($item->blog_discription,250) !!}</p>
                            ...
                            <aside class="blog__sidebar">
                                ...
                                <div class="widget">
                                    ...
                                    <ul class="sidebar__cat">
                                        ...
                                        <li class="sidebar__cat__item"><a href="{{route('category.blogs',$category->id)}}">{{$category->name}}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                                <!-- <div class="widget">
